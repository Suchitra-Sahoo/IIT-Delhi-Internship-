...
import illustration3 from '../Landing-Page-Assets/illustration3.png';
import illustration4 from '../Landing-Page-Assets/illustration4.png';
import illustration5 from '../Landing-Page-Assets/illustration5.png'
import illustration6 from '../Landing-Page-Assets/illustration6.png'

function Testimonials() {
  return (
    <div className="bg-[#D3D3D3] py-20 px-4 md:px-16">
